...
def test_get_ipv6_link_local_addr(sim_engine):
    ...
    non_root_link_local_addr = netaddr.IPAddress(
        non_root.get_ipv6_link_local_addr())
...
@pytest.fixture(params=[['02-00-00-00-00-02-00-01', '02-00-00-00-00-02-00-02'],
...
def test_motes_eui64(sim_engine, fixture_motes_eui64, fixture_exec_num_motes):
    ...
    if (('02-00-00-00-00-00-00-02' in fixture_motes_eui64)
            and len(fixture_motes_eui64) == 2 and fixture_exec_num_motes == 3):
